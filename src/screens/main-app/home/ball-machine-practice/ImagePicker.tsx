...
const BallPracticeImagePickerContainer: FunctionComponent<Props> = ({ navigation }) => {
...
const addVideoSuccess = (video?:any) => {
    ...
    if (response){
      navigation.navigate('BallPracticeVideoPlayer', {video:response.assets[0]});
    }
    if (video) {
...
export default BallPracticeImagePickerContainer;