  ...
  // }
    ...
    return(
        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              delayPressIn={0}
              onPress={()=> {
                navigation.navigate('UploadBallPracticeScreen', {title:'Upload LEFT-Handed Serve'});
              }}
            >
      ...
      >
              ...
              delayPressIn={0}
              onPress={()=> {
                navigation.navigate('UploadBallPracticeScreen', {title:'Upload RIGHT-Handed Serve'});
              }}
            >
              <AutoHeightImage source={uploadIcon} width={((SCREEN_WIDTH * 0.9) / 2) - 23} />
          ...
          >
            <TouchableOpacity
              ...
              onPress={()=> {
                // navigation.navigate('RecordPractice');
                // navigation.navigate('TensorCameraContainer', {title:'RECORD RIGHT-HANDED SERVE'});
                navigation.navigate('BallPracitceAnalysisGridScreen', {title: 'Analysis Report'})
                // startRecording();
