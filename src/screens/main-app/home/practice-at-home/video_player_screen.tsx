...
const HomePracticeVideoPlayerContainer = ({navigation, route}) => {
  ...
  const handleShowGraphButton = () => {
    navigation.navigate('HomePracticeRenderGraphScreen', {graphData: video.analysisData})
  };
...
export default HomePracticeVideoPlayerContainer;
