...
import { StyleSheet, View, ActivityIndicator, Text, Platform, Dimensions, Button, } from 'react-native';
...
export default function TensorFlowServePracticeCameraContainer({navigation, route}) {
