...
import {StyleSheet, SafeAreaView, View, Image, ScrollView, Alert, Text, Button} from 'react-native';
import {DemoTitle, DemoButton, DemoResponse} from '../components';
import { addVideoService } from '../../../../services/servePracticeServices';
import { uploadPhotoService, uploadVideoService, getThumbnailURL } from '../../../../services/mediaServices';
...
const proceedToUploadThumbnail = (newResponse) => {
  ...
  const thumbnailURI = "file:///var/mobile/Containers/Data/Application/24B888DB-B776-4E4D-A328-459705E6087A/tmp/A5F48E77-EB56-4323-A801-AFD6E0F7C1E8.jpg";
  let tempResponse = newResponse.assets[0];

  let photoData = {...tempResponse, thumbnailURL: thumbnailURI};
  uploadPhotoService(photoData, uploadThumbnailSuccess, uploadThubnailFailure);
}
...
const proceedToUploadVideo = () => {
  ...
  const videoURI = "file:///var/mobile/Containers/Data/Application/24B888DB-B776-4E4D-A328-459705E6087A/tmp/A5F48E77-EB56-4323-A801-AFD6E0F7C1E8.jpg";
...
const addVideoSuccess = (video?:any) => {
  ...
  setStatus('Video added!');
    ...
    const videoMetadata = {...res, thumbnailURL: thumbnailURL, videoURL: videoURL}
